...
const FoodReportMonth = (props) => {
    ...
    const reportMonth = () => {
        Api.send('report_monthFood', {'id':userInfo.id, 'token':userInfo.appToken}, (args)=>{
            ...
            if(resultItem.result === 'Y' && arrItems) {
               ...
               console.log(arrItems.sugar_graph)
    ...
    return (
        <Box flex={1} backgroundColor='#fff'>
            ...
            <ScrollView>
                <Box p={5}>
                    <Box>
                        <DefText text='한달간 혈당 수치 변화' style={[styles.reportLabel, {marginBottom:10}]} />
                        <Box>
                            ...
                            <Box height='300px'>
                                <WebView
                                    source={{
                                        uri:'https://khict0107.cafe24.com/adm/rn-webview/bloodsugarFood.php?mode=month&id='+userInfo.id
                                    }}
                                />
                            </Box>
                        </Box>
